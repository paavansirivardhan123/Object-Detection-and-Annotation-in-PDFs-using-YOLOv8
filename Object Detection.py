...
# # Suggested epochs with respective ram if the over all images greater than 1200
...
# The the user must have the pretrained model which is in this path "trained_model/custom_model/weights/best.pt"
